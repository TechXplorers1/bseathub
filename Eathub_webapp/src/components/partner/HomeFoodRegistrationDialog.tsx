...
interface HomeFoodRegistrationDialogProps {
  ...
  onSubmit: (data: any, type: 'Home Food') => Promise<void> | void;
}
...
export function HomeFoodRegistrationDialog({
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      await onSubmit(allData, 'Home Food');
        ...
        <DialogContent className="sm:max-w-md max-h-[90vh] flex flex-col p-0 text-foreground overflow-hidden">
          <ScrollArea className="flex-1 w-full">
            <div className="p-6 space-y-6 pb-12">
              <DialogHeader>
                <DialogTitle className="text-xl text-center font-bold">Home Food Registration</DialogTitle>
                <DialogDescription className="text-center text-sm">
                  Quick setup. Start sharing your home-cooked meals.
                </DialogDescription>
              </DialogHeader>
