...
export let pendingRegistrations: PendingRegistration[] = [
  { id: 'reg1', name: 'The Spicy Taco', type: 'Restaurant', date: '2024-07-28', location: 'California, USA', contactInfo: 'taco@example.com' },
  { id: 'reg2', name: "Anna's Bakery", type: 'Home Food', date: '2024-07-28', location: 'London, UK', contactInfo: 'anna@bakery.com' },
  { id: 'reg3', name: 'Chef Michael', type: 'Chef', date: '2024-07-27', location: 'Paris, FR', contactInfo: '+33 123456789' },
  { id: 'reg4', name: 'Gourmet Grills', type: 'Restaurant', date: '2024-07-26', location: 'Sydney, AU', contactInfo: 'grills@gourmet.com' },
];

export const addPendingRegistration = (registration: Omit<PendingRegistration, 'id' | 'date' | 'location' | 'contactInfo'>) => {
  const newRegistration: PendingRegistration = {
    ...registration,
    id: `reg${Math.floor(Math.random() * 1000)}`,
    date: new Date().toISOString().split('T')[0],
    location: 'New York, USA',
    contactInfo: 'newpartner@example.com',
  };
...
export const allOrders: PlatformOrder[] = [
  { id: 'ORD5551', customerName: 'John Smith', partnerName: 'The Golden Spoon', amount: 45.50, status: 'Delivered', date: '2024-07-28', orderNotes: 'Please leave at the door.' },
  { id: 'ORD5552', customerName: 'Emily Jones', partnerName: "Maria's Kitchen", amount: 25.00, status: 'Preparing', date: '2024-07-28', orderNotes: 'Extra spicy please.' },
  { id: 'ORD5553', customerName: 'David Williams', partnerName: 'Pizza Planet', amount: 33.20, status: 'Out for Delivery', date: '2024-07-28' },
  { id: 'ORD5554', customerName: 'Sarah Brown', partnerName: 'Sushi Palace', amount: 62.10, status: 'Pending', date: '2024-07-28', orderNotes: 'No wasabi.' },
