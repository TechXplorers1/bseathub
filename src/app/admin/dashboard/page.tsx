...
export default function AdminDashboardPage() {
  ...
  // Default to 'organization' when navigating to the settings tab
  const settingsTab = searchParams.get('settings_tab') || 'organization';


  const onTabChange = (tab: string) => {
    // If navigating to settings, we preserve the current settings_tab or default to organization
    if (tab === 'settings') {
        const currentSettingsTab = searchParams.get('settings_tab') || 'organization';
        router.push(`/admin/dashboard?tab=${tab}&settings_tab=${currentSettingsTab}`);
    } else {
      ...
      <h1 className="text-3xl font-bold">Admin Dashboard</h1>
       ...
       <Tabs value={activeTab} onValueChange={onTabChange} className="space-y-4">
        ...
        <TabsContent value="settings" className="space-y-6">
            <Tabs value={settingsTab} onValueChange={onSettingsTabChange} className="space-y-4">
              <TabsList>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2">
                          ...
                          <p className="text-sm text-muted-foreground">Connect your payment gateways. API Keys and webhooks are required.</p>
                          <div className="space-y-2">
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-between items-center p-3 rounded-lg border">
                                <p className="font-mono text-sm truncate">prod_sk_••••••••••••••••••••1234</p>
              ...
              <TabsContent value="data">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Manage data retention, exports, and privacy settings.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">How long to keep operational data like order history.</p>
                        </div>
                        <div className="flex items-center justify-between p-3 rounded-lg border">
                            <div className="space-y-0.5">
