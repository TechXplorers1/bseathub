...
import { customerFeedback } from '@/lib/restaurant-dashboard-data';
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Here's what your customers are saying about your restaurant.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {customerFeedback.map((review, index) => (
            <div key={review.id}>
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    <span className='font-medium text-foreground'>Dish: {review.dish}</span> - "{review.comment}"
                  </p>
                </div>
              </div>
              ...
              {index < customerFeedback.length - 1 && <Separator className="mt-6" />}
            </div>
          ))}
        </CardContent>
      </Card>
