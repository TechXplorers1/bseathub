            ...
            <TabsContent value={activeTab}>
                ...
                <TableBody>
                    ...
                    <TableRow key={reg.id}>
                        ...
                        <Button variant="outline" size="icon" className="mr-2 h-8 w-8" onClick={() => handleRegistration(reg.id, true)}>
                            <Check className="h-4 w-4" />
                        </Button>
                        <Button variant="destructive" size="icon" className="h-8 w-8" onClick={() => handleRegistration(reg.id, false)}>
                            <X className="h-4 w-4" />
                        </Button>
                        </TableCell>
                    </TableRow>
